...
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (3, '1', 1, 'HTML教程', 1, '浏览器和服务器', 9);
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (4, '2', 1, 'HTML教程', 2, '浏览器访问网页原理', 2);
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (5, '3', 1, 'HTML教程', 3, '浏览器请求数据的过程', 86);
...
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (14, '12', 2, 'Python教程', 1, 'Python的自述', 16);
...
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (18, '16', 2, 'Python教程', 5, '输出函数', 2);
...
INSERT INTO onlearning.video (v_id, v_video, v_fid, v_fname, v_cid, v_cname, v_view) VALUES (35, '33', 4, 'MySQL教程', 1, '数据库基本概念', 10);
